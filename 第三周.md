...
1. 只记录 HEAD的变动，例如 git reset ,git commit，像 git checkou -- filename 这样的操作将不会记录
2. git reflog 的记录只会持续几个月，不会永远都在
...
1. 误删掉了一个已经 commit 的文件 index.js
    ...
    恢复：git reflog + git reset --hard SHA1
...
2. [Git 基础 - 查看提交历史]([https://git-scm.com/book/zh/v2/Git-%E5%9F%BA%E7%A1%80-%E6%9F%A5%E7%9C%8B%E6%8F%90%E4%BA%A4%E5%8E%86%E5%8F%B2](https://git-scm.com/book/zh/v2/Git-基础-查看提交历史))
